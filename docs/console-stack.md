...
This is the fleet's console-stack guide — it lives HERE (gateway-auth is
the shared home for everything an app behind the gateway consumes: the
chart, the Go module, the TS package, and this pattern). github-roster is
the **reference implementation**. This document is the transferable part: what the stack is, when to
